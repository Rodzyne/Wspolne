...
<div style="padding-top: 8px;">
	Lokalne URL Pliku:<br>
	<input id="file" class="round" type="text" value="resources/"><br>
</div>
<div>
	Wiadomość:<br>
	<textarea id="message" rows="8" placeholder="Wstaw wiadomość tutaj..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
