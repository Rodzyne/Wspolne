...
name: "Narysuj Zdjęcie na Zdjęciu",
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		Zdjęcie, które jest rysowane:<br>
...
<div style="padding-top: 8px; width: 45%">
	Efekt Narysowania:<br>
	<select id="mask" class="round">
		<option value="0" selected>Zdjęcie Narzucone na Zdjęcie</option>
		<option value="1">Zdjęcie zastępuje Zdjęcie</option>
		<option value="2">Zdjęcie Rysowane z Maską</option>
	</select>
</div>`
},
