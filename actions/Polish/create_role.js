...
<div style="float: right; width: 50%;">
	Kolor:<br>
	<input id="color" class="round" type="text" placeholder="Zostaw puste dla podstawowego!"><br>
	Pozycja:<br>
	<input id="position" class="round" type="text" placeholder="Zostaw puste dla podstawowej!" style="width: 90%;"><br>
</div>
<div>
