...
name: "Wyślij Osadzoną Wiadomość",
...
<div style="float: left; width: 35%;">
Przechowuj Osadzoną Wiadomość W:<br>
...
<div id="varNameContainer3" style="display: ; float: right; width: 60%;">
	Nazwa Przechowywanej Zmiennej:<br>
	<input id="varName3" class="round" type="text">
	</div><br><br><br>
	<div style="padding-top: 8px;">
			<div style="float: left; width: 35%;">
				Jeśli Dostarczanie Wiadomości Się Nie Powiedzie:<br>
			...
			<div id="iffalseContainer" style="display: none; float: right; width: 60%;"><span id="iffalseName">Liczba Akcji</span>:<br><input id="iffalseVal" class="round" type="text"></div>`;
},
