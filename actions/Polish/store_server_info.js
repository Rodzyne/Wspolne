...
name: "Przechowuj Informacje O Serwerze",
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Obiekt Serwera</option>
			<option value="1">ID Serwera</option>
			<option value="2">Server Name</option>
			<option value="3">Server Name Acronym</option>
			<option value="17">Licznik Użytkowników Serwera</option>
			<option value="4">Region Serwera</option>
			<option value="5">URL Ikony Serwera</option>
			<option value="6">Poziom Weryfikacji Serwera</option>
			<option value="7">Podstawowy Kanał Serwera</option>
			<option value="8">Kanał AFK Serwera</option>
			<option value="9">Server System Channel</option>
			<option value="10">Podstawowa Rola Serwera</option>
			<option value="11">Właściciel Serwera</option>
			<option value="12">Obiekt Bota Serwerowego</option>
			<option value="13">Lista Kanałów Serwera</option>
			<option value="14">Lista Roli Serwera</option>
			<option value="15">Lista Użytkowników Serwera</option>
			<option value="16">Lista Emotek Serwera</option>
		</select>
	</div>
</div><br>
<div>
