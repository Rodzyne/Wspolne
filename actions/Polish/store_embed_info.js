module.exports = {
	...
	name: "Przechowuj Informacje O Osadzonej Wiadomości",
	...
	<div>
		<p>
			...
			Zrobiony przez Two (przetłumaczony przez Rodzyne)
		</p>
	</div><br>
<div>
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="1">Okienka W Osadzonej Wiadomości</option>
			<option value="2">Stopa W Osadzonej Wiadomości</option>
			<option value="3">Opis Osadzonej Wiadomości</option>
			<option value="4">URL Obrazka W Osadzonej Wiadomości</option>
			<option value="5">Embed Thumbnail URL</option>
			<option value="6">Kolor Osadzonej Wiadomości</option>
			<option value="7">Nazwa Autora Osadzonej Wiadomości</option>
			<option value="8">URL Ikony Autora Osadzonej Wiadomości</option>
			<option value="9">Tytuł Osadzonej Wiadomości</option>
			<option value="10">URL Osadzonej Wiadomości</option>
