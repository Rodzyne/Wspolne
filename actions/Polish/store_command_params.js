...
name: "Przechowaj Parametry Komendy",
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="info" class="round" onchange="glob.onChange1(this)">
			...
			<option value="2">Oznaczony Użytkownik</option>
			<option value="3">Oznaczona Rola</option>
			<option value="4">Oznaczony Kanał</option>
		</select>
	</div>
	<div style="float: right; width: 60%;">
		<div id="infoCountLabel">Parametr Numer:</div>
