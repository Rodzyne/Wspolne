...
<div>
	<div style="float: left; width: 40%;">
		Znajdź Kanał Głosowy Po:<br>
		<select id="info" class="round">
			<option value="0" selected>ID Kanału Głosowego</option>
			<option value="1">Nazwie Kanału Głosowego</option>
			<option value="2">Pozycji Kanału Głosowego</option>
			<option value="3">Limicie Użytkowników na Kanale Głosowym</option>
			<option value="4">Bitracie Kanału Głosowego</option>
		</select>
	</div>
