...
name: "Stwórz osadzoną wiadomość",
...
<div style="float: left; width: 50%;">
	...
	Autor:<br>
	<input id="author" class="round" type="text" placeholder="Zostaw puste aby nie podawać autora!"><br>
	Kolor:<br>
	<input id="color" class="round" type="text" placeholder="Zostaw puste dla podstawowego koloru!"><br>
	Pokaż znak czasu:<br>
...
<div style="float: right; width: 50%;">
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Zostaw puste dla żadnej!"><br>
	URL ikony autora:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Zostaw puste dla żadnej!"><br>
	URL obrazka:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Zostaw puste dla żadnej!"><br>
	URL miniaturki:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Zostaw puste dla żadnej!"><br>
</div>
<div>
