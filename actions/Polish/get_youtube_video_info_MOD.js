module.exports = {
    ...
    name: "Informacje O Filmie Z YouTube",
    ...
    <div>
      <div>
      <u>Informacje O Modzie:</u><br>Stworzony przez Armağan!
      </div>
      <br>
    
      <div style="width: 95%;">
      URL Filmu Z YouTube:<br>
      <textarea id="videourl" rows="2" placeholder="Wpisz tutuaj url filmu lub użyj zmiennych..." style="width: 95%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
      </div> <br>

      <div style="width: 95%;">
		Klucz API:<br>
        <textarea id="apikey" rows="2" placeholder="Wpisz swój klucz. Zdobądź go z Google. Youtube  API V3" style="width: 95%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
     </div>
     <br>
     <div style="width: 60%;">
		Informacje:<br>
        <select id="outtype" class="round">
         ...
         <optgroup label="Video Info">
			...
			<option value="4">Data Opublikowanie Filmu</option>
            <option value="5">Typ Filmu</option>
            <option value="6">Długość Filmu</option>
         <optgroup label="Video Thubnails">
            <option value="7">URL Miniaturki Filmu </option>
			<option value="8">URL Miniaturki W Średniej Wielkości</option>
            <option value="9">URL Miniaturki W Wysokiej Wielkości</option>
         </optgroup>
        </optgroup>
