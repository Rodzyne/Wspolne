...
name: "Czekaj Na Wiadomość I Przywołaj Akcję",
...
html: function(isEvent, data) {
	...
	<p>
		...
		Stworzony przez MrGold, General Wrex & EliteArtz
	</p>
</div><br>
<div class="codeblock" style="float: left; width: 88%; padding-top: 8px;">
	<p>
	<span style="color:white"><b>Przykłady Filtrów:</b><br><span style="color:#9b9b9b">
