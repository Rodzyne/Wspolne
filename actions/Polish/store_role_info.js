...
name: "Przechowuj Informacje O Roli",
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="1">ID Roli</option>
			<option value="2">Nazwa Roli</option>
			<option value="3">Kolor Roli/option>
			<option value="4">Pozycja Roli</option>
			<option value="5">Historia Edycji Roli</option>
			<option value="6">Czy Rola Jest Możliwa Do Oznaczenia?</option>
			<option value="7">Czy Rola Jest Oddzielona Od Innych?</option>
		</select>
	</div>
</div><br>
<div>
