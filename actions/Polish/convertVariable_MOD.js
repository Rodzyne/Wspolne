	...
	<div>
		<div class="embed" style="width:98%;">
			<embedleftline></embedleftline><div class="embedinfo">
				<span class="embed-auth"><u>Informacje O Modzie:</u><br>Zrobiony przez ${this.author}</span><br>
				<span class="embed-desc">${this.short_description}<br>Dodany W: ${this.version}</span>
			</div>
		</div>
	</div>
	<div style="width: 35%;">
