...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			...
			<option value="1">Nazwie Serwera</option>
			<option value="2">Server Name Acronym</option>
			<option value="3">Liczbie Osób Na Serwerze</option>
			<option value="4"Regionie Serwera</option>
			<option value="5">ID Właściciela Serwera</option>
			<option value="6">Poziomie Weryfikacji Serwera</option>
			<option value="7">Tym Czy Serwer Jest Dostępny</option>
		</select>
	</div>
