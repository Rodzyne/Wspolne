...
<div>
	<div style="float: left; width: 45%;">
		Koniec Zachowania:<br>
		<select id="behavior" class="round">
			<option value="0" selected>Wywołaj Automatycznie Następną Akcję</option>
			<option value="1">Nie Wywołuj Następnej Akcji</option>
		</select>
	</div>
	<div style="padding-left: 5%; float: left; width: 55%;">
		System Interpretacji:<br>
		<select id="interpretation" class="round">
			<option value="0" selected>Wpierw Oceń Tekst</option>
			<option value="1">Oceń Tekst Bezpośrednio</option>
		</select>
	</div>
</div><br><br><br>
