module.exports = {
	...
	<div style="width: 95%; padding-top: 8px;">
		Sekwencja/Sekwencje Do Wyszukania W Google:<br>
		<textarea id="string" rows="5" placeholder="Napisz coś lub podaj zmienne do wyszukania" style="width: 100%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
	 </div><br>
	 <div style="float: left; width: 45%; padding-top: 8px;">
		Informacje:<br>
		<select id="info" class="round">
			<option value="0">Tytuł Rezultu</option>
			<option value="1">URL Rezultu</option>
			<option value="2">Opis Rezultatu</option>
		</select>
	</div>
	<div style="float: left; width: 50%; padding-left: 10px; padding-top: 8px;">
		Numer Rezultatu:<br>
		<select id="resultNo" class="round">
			<option value="0">Pierwszy Rezultat</option>
			<option value="1">Drugi Rezultat</option>
			<option value="2">Trzeci Rezultat</option>
			<option value="3">Czwarty Rezultat</option>
			<option value="4">Piąty Rezultat</option>
			<option value="5">Szósty Rezultat</option>
			<option value="6">Siódmy Rezultat</option>
			<option value="7">Ósmy Rezultat</option>
			<option value="8">Dziewiąty Rezultat</option>
			<option value="9">Dziesiąty Rezultat</option>
		</select>
	</div><br><br>
