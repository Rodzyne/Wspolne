module.exports = {
	...
	<div style="float: left; width: 100%; padding-top: 8px;">
		...
		<select id="info" class="round">
			...
			<option value="4">Państwo</option>
			<option value="5">Region</option>
			<option value="6">Prędkość Wiatru</option>
			<option value="7">Temperatura Odczuwalna</option>
			<option value="8">Kierunek Wiatru</option>
			<option value="9">Wilgotność</option>
			<option value="10">Ciśnienia</option>
			<option value="11">Widoczność W Atmosferze</option>
			<option value="12">Czas Wschodu Słońca</option>
			<option value="13">Czas Zachodu Słońca</option>
		</select>
	</div><br>
	<div>
