...
html: function(isEvent, data) {
	...
	<div>
		<p>
			...
			Stworzone Przez EliteArtz!
		</p><br>
		<p>
			<u>Ogłoszenie:</u><br>
			- Wymaga Discord Bot Maker <b>BETA</b>
		</p>
	</div><br>
Nazwa:<br>
...
<div style="float: left; width: 50%;">
	Pozycja:<br>
	<input id="position" class="round" type="text" placeholder="Zostaw puste dla podstawowego!" style="width: 90%;"><br>
</div>
<div>
