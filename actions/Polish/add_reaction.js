...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" name="second-list" class="round" onchange="glob.onChange1(this)">
			...
			<option value="0">Zwyczajna emotka</option>
			<option value="1">Tymczasowa zmienna</option>
			<option value="2">Serwerowa zmienna</option>
			<option value="3">Globalna zmienna</option>
		</select>
	</div>
