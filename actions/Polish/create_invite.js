...
<div style="padding-top: 8px;">
	<div style="float: left; width: 70%;">
		Liczba maksymalnych użyć:<br>
		<input id="maxUses" class="round" type="text" placeholder="Zostaw puste aby miało nieskończoną ilość uzyć!"><br>
		Długość trwania zaproszenia (w sekundach):<br>
		<input id="lifetime" class="round" type="text" placeholder="Zostaw puste aby nigdy się nie kończyło!"><br>
	</div>
