module.exports = {
	...
	name: "Przechowuj Informacje O Załączniku",
...
<div style="float: left; width: 80%; padding-top: 8px;">
	...
	<select id="info" class="round">
		<option value="0">URL Załącznika</option>
		<option value="1">Nazwa Pliku Załącznika</option>
		<option value="2">Wysokość Załącznika</option>
		<option value="3">Szerokość Załącznika</option>
		<option value="4">Treść Wiadomości Załącznika</option>
		<option value="5">Wielkość Załącznika w (KB)</option>
		<option value="6">ID Wiadomości Z Załącznikiem</option>
	</select>
</div><br><br>
	<div style="float: left; width: 35%; padding-top: 8px;">
		Przechowuj W:<br>
