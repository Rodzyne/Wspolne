...
<div style="padding-top: 8px;">
        <div style="float: left; width: 35%;">
            Jeśli Wysłanie Wiadomości Nie Powiedzie Się:<br>
            <select id="iffalse" class="round" onchange="glob.onChangeFalse(this)">
				<option value="0" selected>Kontynuuj Akcje</option>
				<option value="1">Zakończ Sekwencję Akcji</option>
				<option value="2">Przejdź Do Akcji</option>
				<option value="3">Pomiń Następne Akcje</option>
		 </select>
		</div>
		<div id="iffalseContainer" style="display: none; float: right; width: 60%;"><span id="iffalseName">Akcja Numer</span>:<br><input id="iffalseVal" class="round" type="text"></div>`;
},
