...
name: "Przechowuj Informacje O Członku",
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="1">ID Członka</option>
			<option value="2">Nazwa Członka</option>
			<option value="3">Wyświetlana Nazwa Członka</option>
			<option value="4">Kolor Członka</option>
			<option value="14">Gra Członka</option>
			<option value="15">Status Członka</option>
			<option value="16">URL Avataru Członka</option>
			<option value="5">Serwer Członka</option>
			<option value="6">Ostatnia Wiadomość Członka</option>
			<option value="17">Lista Roli Członka</option>
			<option value="7">Najwyższa Rola Członka</option>
			<option value="8">Najniższa Rola Członka</option>
			<option value="9">Kolor Roli Członka</option>
			<option value="10">Czy Członek Jest Właścicielem Serwera?</option>
			<option value="11">Czy Członek Jest Wyciszony?</option>
			<option value="12">Czy Członek Ma Wyciszony Dźwięk?</option>
			<option value="13">Czy Członek Jest Możliwy Do Zbanowania?</option>
		</select>
	</div>
</div><br>
<div>
