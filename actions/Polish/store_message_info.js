...
name: "Przechowuj Informacje O Wiadomości",
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="2">Tekst Wiadomości</option>
			<option value="3">Autor Wiadomości</option>
			<option value="4">Kanał Gdzie Wysłano Wiadomość</option>
			<option value="5">Czas Wysłania Wiadomości</option>
			<option value="6">Czy Wiadomość Jest Możliwa Do Przypięcia?</option>
			<option value="7">Czy Wiadomość Jest Wiadomością TTS?</option>
		</select>
	</div>
</div><br>
<div>
