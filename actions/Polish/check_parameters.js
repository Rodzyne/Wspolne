...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Liczba parametrów wynosi...</option>
			<option value="1">Liczba oznaczeń użytkownika wynosi...</option>
			<option value="2">Liczba oznaczeń kanału wynosi...</option>
			<option value="3">Liczba oznaczeń roli wynosi...</option>
		</select>
	</div>
