    ...
    <div style="padding-top: 8px;">
        <div style="float: left; width: 45%;">
            ...
            <select id="comparison" class="round" onchange="glob.onChange1(this)">
                <option value="0" selected>Długość Jest Dłuższa Niż</option>
                <option value="1">Długość Jest Krótsza Niż</option>
                <option value="2">Długość Wynosi</option>
            </select>
        </div>
