...
<div>
	<div style="float: left; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Szukaj Po Treści</option>
			<option value="1">Szukaj Po ID</option>
		</select>
	</div><br><br><br>
	<div style="float: left; width: 70%;">
		Szukaj Po:<br>
...
<div>
	<p>
	<u>Notatka:</u><br>
	Ten Mod może jedynie znaleźć wiadomość przez <b>treść</b> z ostatnich 100 wiadomości.<br>
	Jeśli jest więcej wiadomości z tą samą treścią, bot używa zawsze najstraszej wiadomści (po starcie).
</div>`;
},
