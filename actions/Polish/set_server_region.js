...
<div style="padding-top: 8px; width: 90%;">
	...
	<select id="region" class="round">
		...
		<option value="us-west">Zachodnie USA</option>
		<option value="singapore">Singapur</option>
		<option value="eu-central">Centralna Europa</option>
		<option value="hongkong">HongKong</option>
		<option value="us-south">Południowe USA</option>
		<option value="us-central">US Central</option>
		<option value="london">London</option>
		<option value="us-east">Wschodnie USA</option>
		<option value="sydney">Sidney</option>
		<option value="amsterdam">Amsterdam</option>
		<option value="eu-west">Zachodnia Europa</option>
